...
namespace ChessGameTask.Tests
{
    public class ChessGameSimulationTests
    {
        ...
        [Fact]
        public void ChessGameSimulation_RealGameSimulationTest2()
        {
            _game.Move(_game.GetPiece('e', 2), 'e', 4);
            _game.Move(_game.GetPiece('e', 7), 'e', 5);
            _game.Move(_game.GetPiece('c', 2), 'c', 3);
            _game.Move(_game.GetPiece('g', 8), 'f', 6);
            _game.Move(_game.GetPiece('d', 2), 'd', 4);
            _game.Move(_game.GetPiece('f', 6), 'e', 4);
            _game.Move(_game.GetPiece('d', 4), 'e', 5);
            _game.Move(_game.GetPiece('f', 8), 'c', 5);
            _game.Move(_game.GetPiece('d', 1), 'g', 4);
            _game.Move(_game.GetPiece('e', 4), 'f', 2);
            _game.Move(_game.GetPiece('g', 4), 'g', 7);
            _game.Move(_game.GetPiece('h', 8), 'f', 8);
            _game.Move(_game.GetPiece('c', 1), 'g', 5);
            _game.Move(_game.GetPiece('f', 7), 'f', 6);
            _game.Move(_game.GetPiece('e', 5), 'f', 6);
            _game.Move(_game.GetPiece('f', 8), 'f', 6);
            _game.Move(_game.GetPiece('g', 5), 'f', 6);
            _game.Move(_game.GetPiece('c', 5), 'e', 7);

            var check = _game.Move(_game.GetPiece('g', 7), 'g', 8);
            Assert.True(check == MovementResultType.Check);

            _game.Move(_game.GetPiece('e', 7), 'f', 8);
            _game.Move(_game.GetPiece('f', 6), 'd', 8);
            _game.Move(_game.GetPiece('e', 8), 'd', 8);


            var checkMate = _game.Move(_game.GetPiece('g', 8), 'f', 8);
            Assert.True(checkMate == MovementResultType.Checkmate);
            Assert.True(_game.Winner.ChessPlayingColor == Color.White);
        }
    }
}
